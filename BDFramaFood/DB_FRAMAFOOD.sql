...
CREATE TABLE DETALLEPEDIDO (
	...
	CONSTRAINT FK_DETPED_PED  FOREIGN KEY (IDPEDIDO) REFERENCES PEDIDOS(IDPEDIDO),
	CONSTRAINT FK_MESERA_PED FOREIGN KEY (IDPLATO) REFERENCES PLATOS(IDPLATO)
);
GO
...
CREATE TABLE MOVIMIENTOSCAJA (
	...
	CONSTRAINT CK_MOV_TIP CHECK (TIPO IN('EFE','TAR')),-- 'INGRESO', 'RETIRO'
	CONSTRAINT FK_FACT_CAJ FOREIGN KEY (IDCAJERA) REFERENCES USUARIOS(IDUSUARIO)
);
